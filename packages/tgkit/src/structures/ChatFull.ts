...
export default class ChatFull extends Chat {
	...
	constructor(client: Client, data: any) {
		...
		this.businessIntro = data.business_intro && {
			...
			sticker:
				data.business_intro.sticker && new Sticker(client, data.business_intro.sticker),
		};
		this.businessLocation = data.business_location && {
			address: data.business_location.address,
			location:
				data.business_location.location &&
				new Location(client, data.business_location.location),
		};
		...
		this.emojiStatusExpirationDate =
			data.emoji_status_expiration_date && unixToDate(data.emoji_status_expiration_date);
		this.bio = data.bio;
