			...
			request_chat: this.requestChat
				? {
					...
					user_administator_rights: this.requestChat.userAdministratorRights
						? {
							is_anonymous: this.requestChat.userAdministratorRights.isAnonymous,
							can_manage_chat: this.requestChat.userAdministratorRights.canManageChat,
							can_delete_messages: this.requestChat.userAdministratorRights.canDeleteMessages,
							can_manage_video_chats: this.requestChat.userAdministratorRights.canManageVideoChats,
							can_restrict_members: this.requestChat.userAdministratorRights.canRestrictMembers,
							can_promote_members: this.requestChat.userAdministratorRights.canPromoteMembers,
							can_change_info: this.requestChat.userAdministratorRights.canChangeInfo,
							can_invite_users: this.requestChat.userAdministratorRights.canInviteUsers,
							can_post_messages: this.requestChat.userAdministratorRights.canPostMessages,
							can_edit_messages: this.requestChat.userAdministratorRights.canEditMessages,
							can_pin_messages: this.requestChat.userAdministratorRights.canPinMessages,
							can_manage_topics: this.requestChat.userAdministratorRights.canManageTopics
						}
						: undefined,
